...
class RegisterViewTests(TestCase):
    ...
    def test_register_creates_user_and_returns_tokens(self):
        ...
        self.assertTrue(User.objects.filter(email="newuser@example.com", is_active=True).exists())
    ...
    def test_login_returns_tokens_without_otp(self):
        User.objects.create_user(email="login@example.com", password="SecurePass123!")
